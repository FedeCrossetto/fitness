...
const styles = StyleSheet.create({
  ...
  content: { flex: 1, paddingHorizontal: 20, paddingTop: 4, paddingBottom: 12, gap: 14, justifyContent: 'center' },
  titleBlock: { gap: 4 },
  ...
  canvas: { width: '100%', height: 200, backgroundColor: C.surfaceLowest, borderRadius: 12, overflow: 'hidden' },
